...
class User(UserMixin, db.Model):
    ...
    def add_notification(self, name, data):
        self.notifications.filter_by(
            name=name
        ).delete()  # Removes notifications with duplicate name first.
...
class SearchableMixin(object):
    ...
    def search(
    ...
    ):  # cls instead of self because it receives a CLASS not an instance!
        ...
        return (
            ...
            total,
        )  # Case ensures results from db come in same order as IDs are given.
